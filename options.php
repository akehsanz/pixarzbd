...
echo "<ul class='yp-editor-list'>
		...
		<li class='size-option'>
			...
			<div class='yp-this-content'>
				...
				<p class='yp-alert-warning yp-top-alert yp-lite'>Size ".__('properties is not available in lite version.','yp')." <a target='_blank' href='http://wpthemershub.net/azure-pen/buy'>".__('Go Pro','yp')."!</a></p>
		...
		<li class='animation-option'>
			...
			<div class='yp-this-content'>
				...
				<p class='yp-alert-warning yp-top-alert yp-lite'>Animation ".__('property is not available in lite version.','yp')." <a target='_blank' href='http://wpthemershub.net/azure-pen/buy'>".__('Go Pro','yp')."!</a></p>
		...
		<li class='yp-li-footer'>
			<h3><a target='_blank' href='http://wpthemershub.net/azure-pen/documentation/'>".__('Documentation','yp')."</a> / V ".YP_VERSION."</h3>
		</li>
