...
function yp_get_slider_markup($cssName, $name, $default = 'inherit', $decimals, $pxv, $pcv, $emv,$note = null){
    ...
    if(!defined("WTFV")){
	    if($cssName == 'opacity'){
	    	$notice_last = "<p class='yp-alert-warning yp-notice-last'>".ucfirst(strtolower($name))." ".__('property is not available in lite version.','yp')." <a target='_blank' href='http://wpthemershub.net/azure-pen/buy'>".__('Go Pro','yp')."!</a></p>";
	    }
    }
