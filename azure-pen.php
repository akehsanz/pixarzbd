<?php
/*
Plugin Name: WPThemersHub Azure Pen
Plugin URI: http://wpthemershub.net/azure-pen
Description: most advanced visual CSS editor. Customize any theme and any page in real-time without coding.
Version: 2.1.3
Original Author: WaspThemes
Derived from URI: http://waspthemes.com/yellow-pencil
*/
...
function yp_customize_link($links, $file) {
    ...
    if ($file == plugin_basename(dirname(__FILE__) . '/yellow-pencil.php')) {
        ...
        if(!defined("WTFV")){
            $links["go_pro"] = '<a style="color: #39b54a;font-weight: 700;" href="' . esc_url('http://wpthemershub.net/azure-pen/buy/') . '">' . __('Go Pro', 'yp') . '</a>';
        }
...
function yp_get_css($r = false) {
    ...
    if ($onlyCSS != '' && $r == false) {
        ...
        $return .= "\r\n/*\r\n\tThe following CSS generated by Azure  Pen Plugin.\r\n\thttp://wpthemershub.net/azure-pen\r\n*/\r\n";
...
if (!defined('WTFV')){
    ...
    function yp_plugin_links($links, $file) {
        ...
        if ($file == plugin_basename(dirname(__FILE__) . '/yellow-pencil.php')) {
            $links[] = '<a href="http://wpthemershub.net/azure-pen/documentation/">' . __('Documentation', 'yp') . '</a>';
        }
...
function yp_get_export_css($method) {
    ...
    if (empty($allData) == false) {
        ...
        // All in.
        $allOutPut = "/*\r\n\r\n    These CSS codes generated by Azure Pen Editor[WPThemersHub].\r\n";
        $allOutPut .= "    http://wpthemershub.net/azure-pen\r\n\r\n\r\n";
